...
getSyncConfig(['panel_visited', 'panel_closed', 'panel_apps', 'panel_shortcuts',
    ...
    if (results['panel_visited'] !== false || results['panel_closed'] !== false ||
        ...
        function togglePanel (id) {
            ...
            document.body.classList.removeByPrefix('panel-');
    ...
    chrome.sessions.getRecentlyClosed(
        ...
        function (sessions) {
            ...
            if (sessions.length === 0) {
                ...
                p.id = 'no-closed'
                p.textContent = 'No recently closed sessions to show';
            }
            ...
            for (var i in sessions) {
                ...
                a.textContent = session.tab ? session.tab.title : session.window.tabs.length + ' Tabs';
...
chrome.management.getAll(function (list) {
    ...
    store.textContent = 'Chrome Web Store';
});
