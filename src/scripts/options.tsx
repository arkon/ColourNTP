            ...
            <OptionsWrapper>
                ...
                <Tabs activeTab={activeTab} onToggle={handleToggleTab}>
                    <Tab name="General">
                        ...
                        <Checkbox label={`Show ${colourLower} value`} optkey="showColour" value={settings.showColour}>
                    ...
                    <Tab name="Background">
                        ...
                        <Range label={`${colourUpper} overlay opacity`} optkey="bgOpacity" value={settings.bgOpacity} />
                    </Tab>
                    ...
                    <Tab name="Font">
                        <RadioGroup group="font" optkey="font" value={settings.font}>
                            ...
                            <Radio label="Web font" tooltip="Custom font from Google Fonts." value={FontType.WEB}>
